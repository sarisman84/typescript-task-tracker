...
export function drawTaskCard(task) {
    ...
    const header = drawTaskCardHeader(createdAt);
    //Create card body and its related elements
    const body = drawTaskCardBody(description);
...
function drawTaskCardBody(description) {
...
function drawTaskCardHeader(createdAt) {
